    ...
    return (
        <div  className="bg-white dark:bg-gray-900 py-28 container mx-auto">
            ...
            <div className="pt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                {
                    projects?.data?.slice(0, 3).map((project: { _id: string, name: string, image: string, description: string, liveLink :string}) => <div key={project._id} className="card border border-blue-700  bg-gray-800 text-white  shadow-xl">
                        <figure>
                            <Image
                                width={600}
                                height={600}
